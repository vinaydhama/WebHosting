...
**Download & Preview on [TinyTechniques](http://almsaeedstudio.com)**
...
Download from Github or [visit TinyTechniques](http://almsaeedstudio.com) and download the lateset release.
...
- When you contribute, you agree to give a non-exclusive license to TinyTechniques to use that contribution in any context as we (TinyTechniques) see appropriate.
...
License
-------
AdminLTE is an open source project by [TinyTechniques](http://almsaeedstudio.com) that is licensed under [MIT](http://opensource.org/licenses/MIT). TinyTechniques
